	...
	private void initialize() {
		...
		listview1.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> _param1, View _param2, int _param3, long _param4) {
				...
				if (_position == 0) {
					...
					info.setNeutralButton("اتصل ", new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface _dialog, int _which) {
							...
							call.setData(Uri.parse("tel:0555427560"));
							startActivity(call);
						}
					});
					...
					info.setNegativeButton("اتصل 2", new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface _dialog, int _which) {
							call.setAction(Intent.ACTION_DIAL);
							call.setData(Uri.parse("tel:027904683"));
							startActivity(call);
						}
					});
					info.create().show();
				...
				if (_position == 1) {
					info.setTitle(mdi.get((int)(_position)));
					info.setMessage("حي بوتريفيس فوج 58 ( خلف المحطة الحضرية ببحرارة) ");
					info.setNeutralButton("اتصل ", new DialogInterface.OnClickListener() {
						@Override
						public void onClick(DialogInterface _dialog, int _which) {
							call.setAction(Intent.ACTION_DIAL);
							call.setData(Uri.parse("tel:0791457100"));
							startActivity(call);
						}
					});
					info.setPositiveButton("نسخ المعلومات ", new DialogInterface.OnClickListener() {
						@Override
						public void onClick(DialogInterface _dialog, int _which) {
							((ClipboardManager) getSystemService(getApplicationContext().CLIPBOARD_SERVICE)).setPrimaryClip(ClipData.newPlainText("clipboard", mdi.get((int)(_position)).concat("حي بوتريفيس فوج 58 (خلف المحطة الحضرية ببحرارة) \ntel:027917093\ntel:0791457100")));
							SketchwareUtil.showMessage(getApplicationContext(), "تم النسخ! ");
						}
					});
					info.setNegativeButton("اتصل 2", new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface _dialog, int _which) {
							call.setAction(Intent.ACTION_DIAL);
							call.setData(Uri.parse("tel:027917093"));
							startActivity(call);
						}
					});
					info.create().show();
				...
				if (_position == 2) {
					info.setTitle(mdi.get((int)(_position)));
					info.setMessage("حي بوتريفيس طريق بوسعادة 58 /157 (وراء اكمالية مقواس) ");
					info.setNeutralButton("اتصل ", new DialogInterface.OnClickListener() {
						@Override
						public void onClick(DialogInterface _dialog, int _which) {
							call.setAction(Intent.ACTION_DIAL);
							call.setData(Uri.parse("tel:0780251105"));
							startActivity(call);
						}
					});
					info.setPositiveButton("نسخ المعلومات ", new DialogInterface.OnClickListener() {
						@Override
						public void onClick(DialogInterface _dialog, int _which) {
							((ClipboardManager) getSystemService(getApplicationContext().CLIPBOARD_SERVICE)).setPrimaryClip(ClipData.newPlainText("clipboard", mdi.get((int)(_position)).concat("جي بوتريفيس طريق بوسعادة 58 /157 (وراء اكمالية مقواس) \ntel:0780251105 \ntel:027875690")));
							SketchwareUtil.showMessage(getApplicationContext(), "تم النسخ! ");
						}
					});
					info.setNegativeButton("اتصل 2", new DialogInterface.OnClickListener() {
						...
						public void onClick(DialogInterface _dialog, int _which) {
							call.setAction(Intent.ACTION_DIAL);
							call.setData(Uri.parse("tel:027875690"));
							startActivity(call);
						}
					});
					info.create().show();
